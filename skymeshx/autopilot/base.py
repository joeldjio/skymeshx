...
Concrete implementations:
    skymeshx.autopilot.mavlink  → ArduPilot + PX4 via MAVLink
    skymeshx.autopilot.px4      → PX4 native via uXRCE-DDS
    skymeshx.autopilot.ardupilot → ArduPilot-specific extensions
