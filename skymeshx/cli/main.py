...
Usage:
    ...
    skymeshx land
    skymeshx rtl
    skymeshx mode LOITER
    skymeshx goto --lat 48.137 --lon 11.575 --alt 20
    skymeshx run script.py
    skymeshx experiment run exp.yaml
    skymeshx ui
...
def main():
    parser = argparse.ArgumentParser(
        prog="skymeshx",
        description="SkyMeshX CLI — scriptable drone research platform",
    )
...
def _launch_ui():
    ...
    The UI is intentionally NOT part of the ``skymeshx`` package — it
