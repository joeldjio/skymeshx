...
from skymeshx.core.fsm import DroneState, StateMachine
...
# canonical implementation in :mod:`skymeshx.sdk.formations` so the SDK,
# the coordinator and the UI all agree on the geometry.
from skymeshx.sdk.formations import formation_offsets as _canonical_offsets
