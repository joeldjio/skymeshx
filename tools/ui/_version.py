"""
Single source of truth for the skymeshx gcs application version.
...
Read at build time by:
  - tools/installer/inno/skymeshx_gcs.iss (#define AppVersion)
  - tools/installer/build.ps1       (output filename)

Update procedure
----------------
1. Bump VERSION here.
2. Update tools/installer/inno/skymeshx_gcs.iss line ``#define AppVersion``.
...
INSTALLER_ASSET_PREFIX: str = "skymeshx-gcs-setup-"

# GitHub repo (owner/name) the updater queries.
GITHUB_REPO: str = "joeldjio/skymeshx-releases"
