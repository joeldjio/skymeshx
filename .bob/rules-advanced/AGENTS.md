...
- See [`skymeshx/cli/main.py`](../../skymeshx/cli/main.py) for implementation
...
- Multiple bridges share one context via reference counting in [`skymeshx/ros/context.py`](../../skymeshx/ros/context.py)

### Frame Conversions (PX4 ROS2)
- PX4 publishes in NED/FRD, ROS2 expects ENU/FLU
- Use `ned_to_enu()`, `enu_to_ned()`, `frd_to_flu()` from [`skymeshx/ros/px4_bridge.py`](../../skymeshx/ros/px4_bridge.py)
...
- See [`skymeshx/__init__.py`](../../skymeshx/__init__.py) for lazy import pattern

### Logger Queue Backpressure
- Queue size: 10000 items (see [`skymeshx/data/logger.py`](../../skymeshx/data/logger.py))
